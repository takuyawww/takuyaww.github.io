          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-1 bg-white/10 rounded text-sm text-white/70">Go <span className="text-white/40">3年</span></span>
                <span className="px-2 py-1 bg-white/10 rounded text-sm text-white/70">Ruby <span className="text-white/40">3年</span></span>
                <span className="px-2 py-1 bg-white/10 rounded text-sm text-white/70">TypeScript <span className="text-white/40">5年</span></span>
                <span className="px-2 py-1 bg-white/10 rounded text-sm text-white/70">JavaScript <span className="text-white/40">5年</span></span>
              </div>
            </div>
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span className="px-2 py-1 bg-white/10 rounded text-sm text-white/70">React <span className="text-white/40">5年</span></span>
              </div>
            </div>
            <div>
